...
export const STATIC_MAPPINGS: StaticMapping[] = [
  ...
  // ── Contact — Phone ────────────────────────
  {
    ...
    patterns: [
      'alternate phone', 'alternate mobile',
      'secondary phone', 'other number', 'alternate number',
    ],
  },
  {
    key: 'contact.phone.primary',
    patterns: [
      'phone', 'mobile', 'contact number', 'primary mobile',
      'phone number', 'mobile number', 'primary phone',
      'calling number', 'whatsapp number', 'phone no',
